...
echo.
pdoc -o ..\docspdoc\build -d google --no-show-source --no-math --no-mermaid --search -t ..\docspdoc\templates\darkmode __init__ firmware/soundtouchfirmware.py firmware/soundtouchfirmwareproduct.py firmware/soundtouchfirmwarerelease.py models/addstation.py models/audiodspaudiomodes.py models/audiodspcontrols.py models/audioproducttonecontrols.py models/audiospeakerattributeandsetting.py models/balance.py models/bass.py models/basscapabilities.py models/bluetoothinfo.py models/capabilities.py models/clockconfig.py models/clocktime.py models/component.py models/contentitem.py models/controllevelinfo.py models/dspmonostereoitem.py models/group.py models/grouprole.py models/grouproletypes.py models/groupstatustypes.py models/hdmiinputselectiontypes.py models/info.py models/infonetworkinfo.py models/introspect.py models/keystates.py models/languagecodes.py models/mediaitemcontainer.py models/mediaserver.py models/mediaserverlist.py models/musicserviceaccount.py models/navigate.py models/navigateitem.py models/navigatemenutypes.py models/navigateresponse.py models/networkinfo.py models/networkinfointerface.py models/networkstatus.py models/networkstatusinterface.py models/nowplayingstatus.py models/performwirelesssitesurveyresponse.py models/playinfo.py models/playstatustypes.py models/powermanagement.py models/preset.py models/presetlist.py models/productcechdmicontrol.py models/productcechdmimodes.py models/producthdmiassignmentcontrols.py models/rebroadcastlatencymode.py models/recent.py models/recentlist.py models/removestation.py models/repeatsettingtypes.py models/search.py models/searchfiltertypes.py models/searchresult.py models/searchsorttypes.py models/searchstation.py models/searchstationartists.py models/searchstationresults.py models/searchstationsongs.py models/searchterm.py models/service.py models/serviceAvailability.py models/setuprequest.py models/setuprequeststates.py models/shufflesettingtypes.py models/simpleconfig.py models/softwareupdatecheckresponse.py models/softwareupdatequeryresponse.py models/soundtouchconfigurationstatus.py models/sourceitem.py models/sourcelist.py models/speakerattributeandsetting.py models/supportedurl.py models/supportedurls.py models/surveyresultitem.py models/systemtimeout.py models/trackinfo.py models/userplaycontrol.py models/userplaycontroltypes.py models/userrating.py models/userratingtypes.py models/usertrackcontrol models/usertrackcontroltypes.py models/volume.py models/wirelessprofile.py models/wirelessprofileactive.py models/wirelesssecuritytypes.py models/zone.py models/zonemember.py uri/soundtouchnodes.py uri/soundtouchuri.py uri/soundtouchuriscopes.py uri/soundtouchuritypes.py ws/soundtouchwebsocket.py bstappmessages.py bstconst.py bstutils.py soundtouchclient.py soundtouchdevice.py soundtouchdiscovery.py soundtoucherror.py soundtouchitemtypes.py soundtouchkeys.py soundtouchmessage.py soundtouchmodelrequest.py soundtouchnotifycategorys.py soundtouchsources.py soundtouchwarning.py
